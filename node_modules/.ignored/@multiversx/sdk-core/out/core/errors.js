 ...
 */
class ErrGasLimitCannotBeEstimated extends Err {
    constructor(error) {
        super(`Failed to estimate gas limit: [${error}]`, error);
    }
}
exports.ErrGasLimitCannotBeEstimated = ErrGasLimitCannotBeEstimated;
class ErrEstimateTransactionCost extends Err {
    constructor(message) {
        super(message);
    }
}
exports.ErrEstimateTransactionCost = ErrEstimateTransactionCost;
